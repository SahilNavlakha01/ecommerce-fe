...
import WebSocketProgress from './WebSocketProgress'
...
export default function BulkUpload({ onUploadComplete, onClose }: BulkUploadProps) {
  ...
  return (
    <>
      <FormLoading show={uploading} message="Uploading products..." />
          ...
          <div className="mt-6 bg-gray-50 rounded-lg p-4">
            ...
            {uploadStatus.errors && uploadStatus.errors.length > 0 && (
              <div className="bg-red-50 border border-red-200 rounded-lg p-4">
                <h4 className="font-medium text-red-900 mb-2">All Errors:</h4>
