              ...
              <div className="bg-gray-50 rounded-2xl p-6 border border-gray-100 space-y-5">
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm font-medium text-gray-900">support@ethnicsparkles.com</p>
